...
class Dict:
    ...
    a dictionary (*) for unpacking, it is not for function but just 
    ...
    def combination_of_values(self):
        ...
        for combo in itertools.product(
            *[self.dict[k] for k in sorted(self.dict.keys())]
        ):
    ...
    Rather than immutable objects such as int, float and str, mutable objects 
    such as list and dict be careful when assigning.

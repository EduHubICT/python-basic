...
class TestList(unittest.TestCase):
    ...
    def test_find_longest_word(self):
        ...
        self.assertEqual(find_longest_word(['Dhaka', 'khunla', 'Chattogram', 'barisal']), 'Chattogram')
    ...
    def test_count_word(self):
        self.assertEqual(count_word('the quick brown fox jumps over the lazy dog.'), {'the': 2, 'jumps': 1, 'brown': 1, 'lazy': 1, 'fox': 1, 'over': 1, 'quick': 1, 'dog.': 1})
        self.assertEqual(count_word('We are the Champion, We are the'), {'We': 2, 'are': 2, 'the': 2, 'Champion,': 1})

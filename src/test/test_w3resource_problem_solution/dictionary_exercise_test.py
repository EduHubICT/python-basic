...
class DictTest(unittest.TestCase):
    def test_sort_dict_descending_order(self):
        ...
        self.assertEqual(
            _dict.sort_dict_descending_order(), {3: 4, 4: 3, 1: 2, 2: 1, 0: 0}
        )

    def test_concatenate_dicts(self):
        _dict = Dict({1: 10, 2: 20})
        self.assertEqual(
            _dict.concatenate_dicts({3: 30, 4: 40}), {1: 10, 2: 20, 3: 30, 4: 40}
        )

    def test_create_dict_within_range(self):
        _dict = Dict({})
        self.assertEqual(
            _dict.create_dict_within_range(5), {1: 1, 2: 4, 3: 9, 4: 16, 5: 25}
        )

    def test_two_lists_into_dictionary(self):
        _dict = Dict({})
        self.assertEqual(
            _dict.two_lists_into_dictionary(["red", "green", "blue"], [1, 2, 3]),
    ...
    def test_common_keys_sum(self):
        ...
        self.assertEqual(
            _dict.common_keys_sum({"a": 300, "b": 200, "d": 400}),
    ...
    def test_string_to_dictionary(self):
        _dict = Dict({})
        self.assertEqual(
            _dict.string_to_dictionary("w3resource"),

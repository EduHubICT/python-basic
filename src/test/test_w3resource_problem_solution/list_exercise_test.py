...
class TestList(unittest.TestCase):
    ...
    def test_sort_nested_dictionary(self):
        self.assertEqual(sort_nested_dictionary([{'key': {'subkey': 1}},\
                                                 {'key': {'subkey': 10}},\
                                                 {'key': {'subkey': 5}}]),\
    ...
    def test_split_list_nth_element(self):
        self.assertEqual(split_list_nth_element(['a', 'b', 'c', 'd', 'e',\
                                                 'f', 'g', 'h', 'i', 'j',\
                                                 'k', 'l', 'm', 'n'], 3),\
                         [['a', 'd', 'g', 'j', 'm'], ['b', 'e', 'h', 'k', 'n'],\
                          ['c', 'f', 'i', 'l']])
    ...
    def test_remove_specific_key(self):
        self.assertEqual(remove_specific_key([{'key1':'value1', 'key2':'value2'},\
                                              {'key1':'value3', 'key2':'value4'}]),
                         [{'key2': 'value2'}, {'key2': 'value4'}])
        
    def test_string_to_list(self):
        self.assertEqual(string_to_list("['Red', 'Green', 'White']"),\
                         ['Red', 'Green', 'White'])
        
    def test_replace_last_item(self):
        self.assertEqual(replace_last_item([1, 3, 5, 7, 9, 10], [2, 4, 6, 8]),\
                         [1, 3, 5, 7, 9, 2, 4, 6, 8])
        
    def test_tuple_with_smallest_second_value(self):
        self.assertEqual(tuple_with_smallest_second_value([(4, 1), (1, 2), (6, 0)]),\
                         (6, 0))
        
    def test_access_by_index(self):
        self.assertEqual(access_by_index({'physics': 80, 'math': 90, 'chemistry': 86}),\
                         None)
        
    def test_find_list_highest_sum(self):
        self.assertEqual(find_list_highest_sum([[1,2,3], [4,5,6], [10,11,12], [7,8,9]]),\
                         [10, 11, 12])
    ...
    def test_extend_list(self):
        self.assertEqual(extend_list([10, 20, 30],[40, 50, 60]), [40, 50, 60, 10, 20, 30])
        
    def test_list_of_lists_remove_duplicate(self):
        self.assertEqual(list_of_lists_remove_duplicate([[10, 20], [40], [30, 56, 25],\
                                                         [10, 20], [33], [40]]),\
                         [[10, 20], [30, 56, 25], [33], [40]])
        
    def test_compress(self):
        self.assertEqual(compress([0, 0, 1, 2, 3, 4, 4, 5, 6, 6, 6, 7, 8, 9, 4, 4 ]),\
    ...
    def test_encode_list(self):
        self.assertEqual(encode_list([1, 1, 2, 3, 4, 4.3, 5, 1]),\
    ...
    def test_insert_spec_position(self):
        self.assertEqual(insert_spec_position(12, [1, 1, 2, 3, 4, 4, 5, 1], 3), [1, 1, 12, 2, 3, 4, 4, 5, 1])
